...
df_evol_norm.to_csv(join(rootdir, "summary", "raw_summary_norm.csv"), index=False)
#%%
# "netname",
mask = ~df_evol_norm.optimmethod.isin(["CholCMA_class",])
meansumdf_norm = df_evol_norm[mask].groupby(["layer", "RFresize", "optimmethod", "GANname"])\
...
plt.xticks(rotation=40)
plt.tight_layout()
saveallforms(figdir, "score_norm_by_optim_GAN_bar")
plt.show()
